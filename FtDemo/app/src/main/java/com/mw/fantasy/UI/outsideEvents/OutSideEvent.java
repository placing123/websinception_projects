...
public class OutSideEvent extends BaseActivity {
   ...
   /* @BindView(R.id.toolbar)
    ...
    @BindView(R.id.title)
    com.mw.fantasy.customView.CustomTextView mCustomTextViewTitle;*/
    ...
    public void init() {
     ...
     //   mCustomTextViewTitle.setText(com.mw.fantasy.utility.AppUtils.getStrFromRes(R.string.app_name));
