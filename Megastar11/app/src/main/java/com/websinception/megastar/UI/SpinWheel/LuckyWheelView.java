...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        Log.d("ksbhjsbhfbb", "init: "+height + "   "+width);
        if (attrs != null) {
            ...
            mTopTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwTopTextSize, (int) LuckyWheelUtils.convertDpToPixel(14f, getContext()));
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) LuckyWheelUtils.convertDpToPixel(8f, getContext()));
