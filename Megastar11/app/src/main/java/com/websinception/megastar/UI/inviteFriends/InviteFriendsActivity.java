package com.websinception.megastar.UI.inviteFriends;
                ...
                public void onSuccess(ResponseReferralDetails user) {
                    ...
                    if (user.getData() != null) {
                        AppUtils.shareTextUrl(context, AppUtils.getStrFromRes(R.string.inviteFriendsMore),
                                "Here's Rs." + user.getData().getReferToBonus() + " to play " + AppUtils.getStrFromRes(R.string.app_name) + " Cricket with me on " + AppUtils.getStrFromRes(R.string.app_name) + ". Click https://megastar11.com/apk/megastar11.apk to download the " + AppUtils.getStrFromRes(R.string.app_name) + " app and use my code " +
