package com.websinception.megastar.UI.myContest;
...
import com.websinception.megastar.UI.myMatches.MyMatchesFragment;
...
import com.websinception.megastar.UI.homeFragment.HomeCricketPresenterImpl;
import com.websinception.megastar.UI.homeFragment.HomeFragmentView;
import com.websinception.megastar.UI.homeFragment.MultipleImageAdapter;
...
public class MyContestListing extends BaseFragment implements HomeFragmentView {
    ...
    com.websinception.megastar.base.Loader loader;
    Context mContext;
...
//                            tab_sportSelector.getTabAt(1).setIcon(R.drawable.ic_type_yellow_foot);
            ...
            //initiate loader
            loader = new com.websinception.megastar.base.Loader(getCurrentView());
