...
//import com.websinception.megastar.utility.AnimatorListener;
//
...
//        @AnimationType
//        private int animationType = this.animationType;
//        @ColorInt
//        private int selectedCircleColor = this.selectedCircleColor;
//        @Dimension
//        private int selectedCircleRadius = this.selectedCircleRadius;
//        @ColorInt
//        private int selectedTextColor = this.selectedTextColor;
//        @ColorInt
//        private int doneCircleColor = this.doneCircleColor;
//        @Dimension
//        private int doneCircleRadius = this.doneCircleRadius;
//        @ColorInt
//        private int doneTextColor = this.doneTextColor;
//        @ColorInt
//        private int nextTextColor = this.nextTextColor;
//        @Dimension
//        private int stepPadding = this.stepPadding;
//        @ColorInt
//        private int nextStepLineColor = this.nextStepLineColor;
//        @ColorInt
//        private int doneStepLineColor = this.doneStepLineColor;
//        @Dimension
//        private int stepLineWidth = this.stepLineWidth;
//        @Dimension(unit = Dimension.SP)
//        private float textSize = this.textSize;
//        @Dimension
//        private int textPadding = this.textPadding;
//        @ColorInt
//        private int selectedStepNumberColor = this.selectedStepNumberColor;
//        @Dimension(unit = Dimension.SP)
//        private float stepNumberTextSize = this.stepNumberTextSize;
//        @ColorInt
//        private int doneStepMarkColor = this.doneStepMarkColor;
//        private int animationDuration = this.animationDuration;
...
//            this.animationDuration = animationDuration;
//            paint.setTypeface(typeface);
//            if (steps != null && !this.steps.equals(steps)) {
//                setSteps(steps);
//            } else if (stepsNumber != 0 && stepsNumber != this.stepsNumber) {
//                setStepsNumber(stepsNumber);
//            } else {
//                invalidate();
//            }
