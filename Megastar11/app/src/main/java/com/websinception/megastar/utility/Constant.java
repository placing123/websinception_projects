...
public interface Constant {
    ...
    String PRIVACY_POLICY_URL = AppConfiguration.WEB_URL + "privacyPolicy.html?type=mobile";
    String TERMS_CONDITIONS_URL = AppConfiguration.WEB_URL + "TermConditions.html?type=mobile";
    String ABOUT_URL = AppConfiguration.WEB_URL + "AboutUs.html?type=mobile";
    String HELP_DESK_URL = AppConfiguration.WEB_URL + "faq.html?type=mobile";
    String LEGALITY_URL = AppConfiguration.WEB_URL + "Legalities.html?type=mobile";
    String FANTASY_CRICKET = AppConfiguration.WEB_URL + "how-to-play-fantasy-cricket.html?type=mobile";
    String POINT_SYSTEM_CRICKET_URL = AppConfiguration.WEB_URL + "PointSystem.html?type=mobile";
    String HOW_TO_PLAY_URL = AppConfiguration.WEB_URL + "how-to-play-fantasy-cricket.html?type=mobile";
    ...
    String WORK_WITH_US = AppConfiguration.WEB_URL + "contactUs.html?type=mobile";
