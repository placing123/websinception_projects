...
<div class="panel-body" ng-controller="PageController" ><!-- Body -->
    ...
    <div class="form-area" style="max-width:70%; margin: auto; border:1px solid #f7f7f7; padding:10px;">
        ...
        <form id="add_form" name="add_form" autocomplete="off" >
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control chosen-select" ng-change="getType(Redirection)" ng-model="Redirection" name="Redirection">
            ...
            <div class="row">
                <div class="col-md-12" ng-if="Redirection == 'Dfs' || Redirection == 'Gully' ">
                    <div class="form-group">
                        <label class="filter-col" for="ParentCategory">Match</label>
                        <select id="MatchGUID" ng-model="info.MatchGUID" name="MatchGUID" class="form-control chosen-select">
                            <option value="">Please Select</option>
            ...
            <div class="row">
                <div class="col-md-12" ng-if="Redirection == 'Auction'">
                    <div class="form-group">
                        <label class="filter-col" for="CategoryTypeName">Series</label>
                        <select id="SeriesGUID" name="SeriesGUID" ng-model="info.SeriesGUID" ng-change="getMatches(SeriesGUID, '')" class="form-control chosen-select">
                            <option value="">Please Select</option>
            ...
            <div class="row">
                <div class="col-md-12" ng-if="Redirection == 'FT-Dfs'">
                    <div class="form-group">
                        <label class="filter-col" for="ParentCategory">Match</label>
                        <select id="MatchGUID" ng-model="info.MatchGUID" name="MatchGUID" class="form-control chosen-select">
                            <option value="">Please Select</option>
                            <option ng-repeat="match in FootballMatchData" value="{{match.MatchGUID}}">{{match.TeamNameLocal}} Vs {{match.TeamNameVisitor}} ON {{match.MatchStartDateTime}}</option>
                        </select>
                        <small>Select this option to select match according to selected series.</small>  
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-12 d-flex">
                            <div class="col-md-3">
                                <input name="UserType" ng-model="UserType" ng-click="getUser('All')" type="radio" class="Type" value="All"> All Users
                            </div>
                            <div class="col-md-3">
                                <input name="UserType" ng-model="UserType" ng-click="getUser('Selected',Redirection)" type="radio" class="Type" value="Selected"> Selected Users
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" ng-if="UserType == 'Selected' ">
                ...
                <div class="col-md-8" ng-if="AllUsers.length > 0">
                    <div class="form-group">
                        ...
                        <select class="form-control chosen-select" name="selectedUser[]" multiple="">
                            ...
                            <option ng-repeat="User in AllUsers" ng-if="User.Email || User.PhoneNumber" value="{{User.UserID}}">{{(User.Email) ? User.Email : User.PhoneNumber}} ({{User.FirstName}})</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <button type="submit" class="btn btn-success btn-sm" ng-disabled="addDataLoading" ng-click="MatchBroadcast()">Send</button>
    </div>
