...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
    ...
    <div class="clearfix mt-2 mb-2">
        ...
        <div class="float-right">
            <button class="btn btn-default btn-secondary btn-sm ng-scope" data-toggle="modal" data-target="#delete_model_all"><img src="asset/img/signs.svg"></button>
        </div>
        <div class="float-right">
                        ...
                        <div class="table-responsive block_pad_md" > 
                            ...
                            <div class="table-responsive block_pad_md" infinite-scroll="getList(Status)" infinite-scroll-disabled='data.listLoading' infinite-scroll-distance="0"> 
                                ...
                                <!-- data table -->
                                    ...
                                    <table class="table table-striped table-condensed table-hover table-sortable all-table-scroll cricket_contests_table contests" ng-if="data.dataList.length">
                                        <!-- table heading -->
                                        <thead>
                                            <tr>
                    ...
                    <div class="modal-body">
                        <div class="form-area">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="filter-col" for="Status">ContestFull</label>
                                        <select id="ContestFull" name="ContestFull" class="form-control chosen-select">
                                            <option value="">Please Select </option>
                                            <option value="Yes">Filled</option>
                                            <option value="No">Unfilled</option>
                                        </select>   
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Delete All Modal -->
    <div class="modal fade" id="delete_model_all" >
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title h5">signs.svg All Contest</h3>         
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>

                <!-- Filter form -->
                <form id="Delete_all" role="form" autocomplete="off" class="ng-pristine ng-valid">
                    <div class="modal-body">
                        <div class="form-area">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-sm" onclick="$('#Delete_all_from').trigger('reset'); $('.chosen-select').trigger('chosen:updated');">Reset</button>
                        <button type="submit" class="btn btn-success btn-sm"  ng-click="delete_all()">Apply</button>
                    </div>
