                ...
                <div class="col-xl-3 col-sm-6 py-2">
                    <div class="card">
                        <div class="card-body custom-card-body">
                            ...
                            <div class="card-info col-9" ng-click="LoadUserList('Subscribe')">
                                <h6>Total Subscription Users</h6>
                                <h4>{{data.dataList.TotalSubscriptionUsers}}</h4>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- 
    ...
    <nav class="matches_tab">
        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
            ...
            <!-- <a class="nav-item nav-link" id="nav-football-tab" data-toggle="tab" href="#football" role="tab" aria-controls="nav-profile" aria-selected="false"> Football </a> -->
        </div>
    </nav>
