<header class="panel-heading d-flex align-items-center justify-content-between">
    <h1 class="h4"><?php echo $this->ModuleData['ModuleTitle']; ?></h1>
        <a href="<?php echo API_URL.'utilities/autoJoinContestVirtualUser';?>" target="_blank" class="btn btn-success btn-sm ng-scope">Validate contest cron</a>
                ...
                <div class="verified_tabs">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#" role="tab" aria-controls="nav-home" aria-selected="true" ng-click="applyFilter('Yes');">Confirmed</a>
                            <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#" role="tab" aria-controls="nav-profile" aria-selected="false" ng-click="applyFilter('No');">Non confirmed</a>
                        </div>
                    </nav>
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="table-responsive block_pad_md" > 
                                    ...
                                    <!-- Data table -->
                                    <div class="table-responsive block_pad_md pt-3" infinite-scroll="getList(Status)" infinite-scroll-disabled='data.listLoading' infinite-scroll-distance="0"> 
                                        <!-- loading -->
                                        <p ng-if="data.listLoading" class="text-center data-loader"><img src="asset/img/loader.svg"></p>

                                        <table class="coupon_pad table table-striped table-condensed table-hover table-sortable all-table-scroll coupon_pad" ng-if="data.dataList.length">
                                            <!-- table heading -->
                                            <thead>
                                                <tr>
                                                    <th>Contest Name</th>
                                                    <th>Active On Series</th>
                                                    <th>Type</th>
                                                    <th>Is Paid?</th>
                                                    <th>Size</th>
                                                    <th>Privacy</th>
                                            ...
                                            <tbody id="tabledivbody">
                                                <tr scope="row" ng-repeat="(key, row) in data.dataList" id="sectionsid_{{row.MenuOrder}}.{{row.CategoryID}}">
                                                    ...
                                                    <td>
                                                        <div class="content float-left user_table"><strong><a href="javascript:void(0)" >{{row.ContestName}}</a></strong>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="text-primary">{{row.AllSeries == 'Yes' ? 'All' : row.Series }}</p>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown action_toggle">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-left">
                                                                ...
                                                                <a class="dropdown-item" href="" ng-click="loadFormStatus(key, row.PreContestID)">Status</a>
                                                            </div>
                                                        </div>
