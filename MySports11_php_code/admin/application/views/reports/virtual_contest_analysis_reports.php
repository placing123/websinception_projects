...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
    ...
    <div class="clearfix mt-2 mb-2" ng-init="getVirtualContestName()">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="ContestType" ng-model="ContestType" name="ContestType" ng-change="getVirtualContestName(ContestType)" class="form-control chosen-select">
...
<!--                                        <input type="text" name="ContestName" class="form-control"> -->
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success btn-sm" data-dismiss="modal" onclick="check()" ng-disabled="editDataLoading" ng-click="getVirtualContestAnalysisReport()">Apply</button>
                    </div>
