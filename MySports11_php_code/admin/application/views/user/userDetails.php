                                ...
                                <table class="table table-striped table-hover text-center" > 
                                    ...
                                    <tbody>
                                        <tr ng-repeat="transactionDetails in transactions" ng-if="transactions.length">
                                            ...
                                            <td>
                                                <i class="fa fa-rupee"></i>{{ transactionDetails.WalletAmount}}</td>                   
                                            <td>
                                                <i class="fa fa-rupee"></i>{{ transactionDetails.CashBonus}}</td>
                                            <td>
                                                <i class="fa fa-rupee"></i>{{ transactionDetails.WinningAmount}}</td>
                                            
                                            <!-- <td>
                                                <i class="fa fa-rupee"></i>{{ transactionDetails.OpeningWinningAmount}}</td>-->
                                            <td>
                                                <i class="fa fa-rupee" ng-if="transactionDetails.TransactionType == 'Cr'"></i class="fa fa-rupee">{{ transactionDetails.TransactionType=='Cr' ? transactionDetails.Amount : '0.00'}}</td>
                                            <td>
                                                <i class="fa fa-rupee" ng-if="transactionDetails.TransactionType == 'Dr'"></i class="fa fa-rupee">{{ transactionDetails.TransactionType=='Dr' ? transactionDetails.Amount : '0.00'}}</td>
                                            <!-- <td>
