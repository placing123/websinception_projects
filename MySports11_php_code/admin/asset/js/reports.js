app.controller('PageController', function ($scope, $http, $timeout, $rootScope) {
    ...
    $scope.getList = function ()
    {
        ...
        $http.post(API_URL + 'admin/reports/getMatchWiseReports', data, contentType).then(function (response) {
    ...
    $scope.getMatchAllContestReport = function ()
    {
        ...
        $http.post(API_URL + 'admin/reports/getMatchContestAnalysis', data, contentType).then(function (response) {
    ...
    $scope.getMatchAllContestReportExports = function ()
    {
        ...
        $http.post(API_URL + 'admin/reports/getMatchContestAnalysisExports', data, contentType).then(function (response) {
                var response = response.data;
    ...
    /*list append*/
    $scope.luckyWheelReport = function ()
    {
        $scope.data = angular.copy($scope.orig); /*copy and reset from original scope*/
        var MatchGUID = '';
        if ($scope.data.listLoading || $scope.data.noRecords)
            return;
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + "&" + $('#filterForm1').serialize();
        $http.post(API_URL + 'LuckyWheel/getReport', data, contentType).then(function (response) {
            $scope.UserResult = response.data.Data.Records;
            if (response.data.ResponseCode == 200) { /* success case */
                $scope.data.pageNo++;
                alertify.success(response.data.Message);
            } else {
    ...
    $scope.getAccountReport = function ()
    {
        ...
        $http.post(API_URL + 'admin/reports/getAccountReport', data, contentType).then(function (response) {
    ...
    {   
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,MatchGUID,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getAccountReportExport', data, contentType).then(function (response) {
                var response = response.data;
                if (response.ResponseCode == 200) { /* success case */
                    var encodedUri = encodeURI(response.Data);
                    var link = document.createElement("a");
    ...
    $scope.getUserReport = function ()
    {
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getUserAnalysisReport', data, contentType).then(function (response) {
    ...
    $scope.getContestName = function (ContestType)
    {
        ...
        $http.post(API_URL + 'admin/reports/getContestName', data, contentType).then(function (response) {
    ...
    $scope.getVirtualContestName = function (ContestType)
    {
        $scope.data = angular.copy($scope.orig); /*copy and reset from original scope*/
        var MatchGUID = '';
        if ($scope.data.listLoading || $scope.data.noRecords)
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&ContestType=' + ContestType;
        $http.post(API_URL + 'admin/reports/getVirtualContestName', data, contentType).then(function (response) {
            $scope.ContestNameList = response.data.Data;
            $scope.data.listLoading = false;
            $timeout(function () {
                $("select.chosen-select").chosen({width: '100%', "disable_search_threshold": 8}).trigger("chosen:updated");
    ...
    $scope.getContestPrivateName = function (ContestType)
    {
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&ContestType=' + ContestType;
        $http.post(API_URL + 'admin/reports/getContestPrivateName', data, contentType).then(function (response) {
            $scope.ContestNameList = response.data.Data;
            $scope.data.listLoading = false;
            $timeout(function () {
                $("select.chosen-select").chosen({width: '100%', "disable_search_threshold": 8}).trigger("chosen:updated");
    ...
    $scope.getContestReport = function ()
    {
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getContestAnalysisReport', data, contentType).then(function (response) {
    ...
    $scope.getPrivateContestAnalysisReport = function ()
    {
        ...
        if ($scope.data.listLoading || $scope.data.noRecords)
            return;
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=Yes&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getPrivateContestAnalysisReport', data, contentType).then(function (response) {
            $scope.ContestAnalysis = response.data.Data;
            if (response.data.ResponseCode == 200) { /* success case */
                $scope.data.pageNo++;
                alertify.success(response.data.Message);
    ...
    {   
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getUserRegisterReport', data, contentType).then(function (response) {
            $scope.data.listLoading = false;
            $scope.UserDataReports = response.data.Data;
            $rootScope.firstItem = $scope.UserDataReports[0].EntryDate;
            // console.log($rootScope.firstItem);
            $rootScope.lastItem = $scope.UserDataReports[$scope.UserDataReports.length-1].EntryDate;
            var ChartGraphDate = [];
            var ChartGraphUser = [];
            ...
            response.data.Data.forEach(element => {
                ...
                $scope.totalUser += parseInt(element.TotalUsers);
            });
            window.chartColors = {
                red: 'rgb(255, 99, 132)',
    ...
    {   
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getUserJoinedFeeReport', data, contentType).then(function (response) {
            ...
            response.data.Data.TotalList.forEach(element => {
                ChartGraphDate.push([element.EntryDate]);
                ChartGraphUser.push(element.TotalUsers);
                $scope.totalUserJoinFee += parseInt(element.TotalUsers);
            });
            window.chartColors = {
                blue: 'rgb(54, 162, 235)',
            };
    ...
    $scope.getUserPlanningLifetimeReport = function ()
    {
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getUserPlanningLifetimeReport', data, contentType).then(function (response) {
            $scope.data.listLoading = false;
            $scope.UserDataReports = response.data.Data;
            var ChartGraphDate = [];
            var ChartGraphUser = [];
    ...
    $scope.getPrivateContestDataReport = function (SeriesGUID,MatchGUID){
            ...
            $http.post(API_URL + 'admin/reports/getPrivateContestDataReport', data, contentType).then(function (response) {
    ...
    /*list append*/
    $scope.getAuctionContestReport = function ()
    {
        $scope.data = angular.copy($scope.orig); /*copy and reset from original scope*/
        var MatchGUID = '';
        if ($scope.data.listLoading || $scope.data.noRecords)
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/AuctionDrafts/getContestAnalysisReport', data, contentType).then(function (response) {
            $scope.ContestAnalysis = response.data.Data;
            if (response.data.ResponseCode == 200) { /* success case */
                $scope.data.pageNo++;
                alertify.success(response.data.Message);
    ...
    /*list append*/
    $scope.getVirtualContestAnalysisReport = function ()
    {
        $scope.data = angular.copy($scope.orig); /*copy and reset from original scope*/
        var MatchGUID = '';
        if ($scope.data.listLoading || $scope.data.noRecords)
        ...
        $scope.data.listLoading = true;
        var data = 'SessionKey=' + SessionKey + '&GUID=' + MatchGUID + '&PageNo=' + $scope.data.pageNo + '&PageSize=' + $scope.data.pageSize + '&Params=IsVirtualUserJoined,VirtualUserJoinedPercentage,GameType,GameTimeLive,AdminPercent,Privacy,IsPaid,WinningAmount,ContestSize,EntryFee,NoOfWinners,EntryType,TeamNameLocal,TeamNameVisitor,Status,CustomizeWinning,ContestType,MatchStartDateTime,TotalJoined,TotalAmountReceived,TotalWinningAmount,CashBonusContribution,UserJoinLimit&Privacy=No&OrderByToday=Yes&' + $('#filterForm1').serialize() + "&" + $('#filterForm').serialize();
        $http.post(API_URL + 'admin/reports/getVirtualContestAnalysisReport', data, contentType).then(function (response) {
            $scope.ContestAnalysis = response.data.Data;
            if (response.data.ResponseCode == 200) { /* success case */
                $scope.data.pageNo++;
                alertify.success(response.data.Message);
