app.controller('PageController', function ($scope, $http,$timeout){
    ...
    $scope.getList = function ()
    {
        ...
        var data = 'SessionKey='+SessionKey+'&MatchTypeByApi=Real&Filter=AddDays'+'&OrderBy=' + $scope.data.OrderBy + '&Sequence=' + $scope.data.Sequence +'&OrderByToday=Yes&Params='+'SeriesName,MatchDisplay,TotalPlayerCountMatch,TotalPlayerCountPrivate,IsEdited,MatchType,MatchNo,MatchStartDateTime,TeamNameLocal,TeamNameVisitor,TeamNameShortLocal,IsPlayingXINotificationSent,TeamNameShortVisitor,TeamFlagLocal,TeamFlagVisitor,MatchLocation,Status&PageNo='+$scope.data.pageNo+'&PageSize='+$scope.data.pageSize+'&'+$('#filterForm').serialize()+'&'+$('#filterForm1').serialize()+'&StatusID=1';
