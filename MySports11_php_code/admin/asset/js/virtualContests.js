app.controller('PageController', function ($scope, $http, $timeout, $rootScope) {
    ...
    $scope.getList = function ()
    {
        ...
        var WinningType = "Free Join Contest";
    ...
    $scope.getMatches = function (SeriesGUID, Status) {
        $scope.MatchData = {};
        //&StatusID=1
        var data = 'SeriesGUID=' + SeriesGUID + '&MatchTypeByApi=Virtual&Params=MatchNo,MatchStartDateTime,TeamNameLocal,TeamNameVisitor&OrderBy=MatchStartDateTime&Sequence=ASC&Status=' + Status;
    ...
    $scope.addData = function ()
    {
        ...
        $http.post(API_URL + 'admin/contest/addVirtual', data, contentType).then(function (response) {
            var response = response.data;
            if (response.ResponseCode == 200) { /* success case */
    ...
    $scope.editData = function ()
    {
        ...
        inputData.WinningType = "Free Join Contest";
        ...
        $http.post(API_URL + 'admin/contest/editVirtual', data, contentType).then(function (response) {
            var response = response.data;
            if (response.ResponseCode == 200) { /* success case */
                alertify.success(response.Message);
