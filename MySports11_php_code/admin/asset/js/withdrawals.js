...
//                }, 200);
    ...
    $scope.ExportList = function (extention) {
        var data = 'SessionKey=' + SessionKey + '&Status=' + $rootScope.Status + '&Params=Amount,Email,PhoneNumber,PaymentGateway,Status,EntryDate,FirstName,MediaBANK&' + $('#filterForm1').serialize();
