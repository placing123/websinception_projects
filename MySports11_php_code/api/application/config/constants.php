...
define('SITE_NAME', 'SportsDemo');
define('SITE_CONTACT_EMAIL', 'help@SportsDemo.com');
...
define('CompanyName', 'FiktionWorks Pvt Ltd');
define('Year', 2020);

/* for push Notification */
define('CHANNEL_NAME', 'Alert');
define('ANDROID_SERVER_KEY', 'AAAAXU49aVo:APA91bEy5M13hw-QjSrjJViUaSEG8HYoGfg22JEFXBOg7Sk1xj03MQvnvnBNWdYi9Yk5J7CaIBQu1p2o0g9DgtyFFjEhZIsScWVsZqOqR3DgLpn1xh5r7k2uA2I8xJwTF2PtneOrMfQm');
...
define('SPORTS_API_URL_CRICKETAPI', 'https://rest.cricketapi.com');
define('SPORTS_API_ACCESS_KEY_CRICKETAPI', 'fce5bafe9d13a3778e3def40af5c9380');
define('SPORTS_API_SECRET_KEY_CRICKETAPI', '2ea62c7cb2d53afecbc3f2c8ffcb83a1');
define('SPORTS_API_APP_ID_CRICKETAPI', 'Myskill');
...
switch (ENVIRONMENT)
{
    ...
    case 'production':
        /*Paths*/
        define('SITE_HOST', 'https://www.SportsDemo.com/');
        define('ROOT_FOLDER', '');
