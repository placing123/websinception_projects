...
class Entity_model extends CI_Model {
    ...
    function getEntity($Field = 'E.EntityGUID', $Where = array(), $multiRecords = FALSE, $PageNo = 1, $PageSize = 15) {
        ...
        $ReplaceWord=array("","","");
        $Where['EntityID'] = str_replace($FindWord,$ReplaceWord,@$Where['EntityID']);
        $Where['EntityGUID'] = str_replace($FindWord,$ReplaceWord,@$Where['EntityGUID']);
        $Where['EntityTypeName'] = str_replace($FindWord,$ReplaceWord,@$Where['EntityTypeName']);
