	...
	function recovery($Username){
		...
		if (!empty($UserData)){
			...
			if($UserData['StatusID']== 1 || $UserData['StatusID']==2){
				...
				$Token = SITE_NAME.", OTP for Password Reset is: ". $this->generateToken($UserData['UserID'], 1);
			...
			if ($this->Post['type'] != "Email") {
				...
				send_mail(array(
		                    ...
		                    'template_id'   =>  'd-48022674be284246941d7431ba0470d4',
