      ...
      <tr>
        <td>
          <table class="main-wrapper" width="610" border="0" cellspacing="0" cellpadding="0" align="center" style=" border-radius:5px;">
            ...
            <tr>
              <td align="center" style="font-family: 'Roboto', sans-serif; font-size:13px; color:#999999; padding:10px;background-color: #000;">Copyright FiktionWorks Pvt Ltd &copy; <?php echo date('Y') ?> All Rights Reserved.</td>
            </tr>
          </table>
        </td>
      </tr>
