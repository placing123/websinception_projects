...
<p style="font-family: 'Roboto', sans-serif; font-size:16px; color:#444444; font-weight:500; margin-bottom:30px;">Your Friend <?php echo $Name; ?>  invited you. Use his/her invite code: <?php echo $InviteCode; ?> to join the contest and win.</p>
