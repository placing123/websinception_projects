...
class Notification extends MY_Controller
{
   ...
   { // print_r($token);die();
            ...
            define('server_key', 'AAAAHI8L5m0:APA91bG5NHYZ-TjFthswbtqZKBk9K61p_TYlftDBIHMTkRgy9bGgIDrBdTt9gVL5ZwwVX7tzqOsUgsWyWyj8k6AAIEs5ZU-qqPWSJsmjsYmfvc-1yxTUKqzodHWDhzCKItwdMd7wa163');

            $token = [$token];
            //$token = ['eyIcnzjur_I:APA91bFEclQSyqiO_CIDkL9TBTwyxtzQ3-_i2Q08OTGegu7VNqacQ23Yjnj8kNxWx-6hsupqdVK8JSwm9lElGoMKYmyuoKrJoccWGCHcnDPERKqGIyANFBdQ1poL1y5kgMnW5kyZLyX4'];
