...
class Match_model extends CI_Model
{
    ...
    function total_team_joinmatch($id)
    {
       return $this->db->get_where('leaderboard',array('matchid'=>$id))->result();
    }
    
    function total_team_join_contest($id,$contest_id)
    {
        $this->db->select('user_id,teamid');
       return $this->db->get_where('leaderboard',array('matchid'=>$id,"contestid"=>$contest_id))->result();
    }
