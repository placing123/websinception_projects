<div class="content-wrapper">
    ...
    <section class="content">
	 ...
	 <div class="box box-default">
	    ...
	    <div class="form-group">
            <label for="int">Join with multiple Team <?php echo form_error('multiple_team') ?></label>
            <select required class="form-control" name="multiple_team" id="multiple_team">
                <option value="">Select</option>
                <option value="1" <?php if($multiple_teams =="1"){ echo "selected"; } ?> >No</option>
                <option value="2" <?php if($multiple_teams =="2"){ echo "selected"; } ?> >Yes</option>
            </select>
        </div>
	    <div class="form-group">
