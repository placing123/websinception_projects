...
class Points_distribution_rules extends My_Controller
{
    ...
    public function update($id) 
    {
		...
		't10score' => set_value('t10score', $row->t10score),
        't20score' => set_value('t20score', $row->t20score),
        'odiscore' => set_value('odiscore', $row->odiscore),
        'testscore' => set_value('testscore', $row->testscore),
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
        		'title' => $this->input->post('title',TRUE),
        		't10score' => $this->input->post('t10score',TRUE),
                't20score' => $this->input->post('t20score',TRUE),
                'odiscore' => $this->input->post('odiscore',TRUE),
                'testscore' => $this->input->post('testscore',TRUE),
        		'description' => $this->input->post('description',TRUE),
	...
	$this->form_validation->set_rules('t10score', 't10score', 'trim|required|numeric');
    $this->form_validation->set_rules('t20score', 't20score', 'trim|required|numeric');
    $this->form_validation->set_rules('odiscore', 'odiscore', 'trim|required|numeric');
    $this->form_validation->set_rules('testscore', 'testscore', 'trim|required|numeric');
