...
class User_model extends CI_Model
{
    ...
    function get_wallet_amount_credit($id)
    {
        $sql = "SELECT SUM(`amount`) AS `amount` FROM `transection` WHERE `user_id` = '".$id."' AND `type` = 'credit' AND `transaction_status` = 'TXN_SUCCESS'" ;
    ...
    function get_wallet_amount_debit($id)
    {
        $sql = "SELECT SUM(`amount`) AS `amount` FROM `transection` WHERE `user_id` = '".$id."' AND `type` = 'debit'" ;
    ...
    function get_wallet_amount_winning($id)
    {
        $sql = "SELECT SUM(`amount`) AS `amount` FROM `transection` WHERE `user_id` = '".$id."' AND `type` = 'winning'" ;
    ...
    function get_wallet_amount_winning_debit($id)
    {
        $sql = "SELECT SUM(`amount`) AS `amount` FROM `transection` WHERE `user_id` = '".$id."' AND `type` = 'winning_debit'" ;
    ...
    function referral_users_list($code)
    {
        $this->db->select('name,user_id,user_id,mobile,email,code,image');
