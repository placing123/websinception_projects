   ...
   <div class="box box-default">
        ...
        <div class="box-body wizard-content">
                    <div class="ibox-title">
                        <?php echo anchor(site_url('contest/create/'.$this->uri->segment('3')),'Create', 'class="btn btn-primary"'); ?>
            ...
            <td>
                <?php if($contest->cancelled =="1"){?>
                    <button style="border-radius: 6px;" type="button" class="btn btn-success">Contest Cancelled</button>
