<div class="content-wrapper">
    ...
    <script>
        function showimage() {
          ...
          var type = document.getElementById("notification_type");
          
          if (type.value == '1')/*x.style.display === "none"*/ 
          {
          ...
          if (type.value == "")/*x.style.display === "none"*/ 
          {
            x.style.display = "none";
          }
    ...
    <section class="content">
	 ...
	 <div class="box box-default">
        ...
        <div class="form-group">
            <label for="varchar">Notification Type<?php echo form_error('notification_type') ?></label>
            <select class="form-control"  name="notification_type" id="notification_type" onchange="showimage()">
                <option value="">Select Type</option>
                <option value="0">Text</option>
                <option value="1">Text with Image</option>
            </select>
        </div>
        <div class="form-group" id="imagediv" style="display: none">
            <label for="varchar">Image<?php echo form_error('image') ?></label>
            <input type="file" class="form-control" name="image" id="image" placeholder="Image" value="">
        </div>
