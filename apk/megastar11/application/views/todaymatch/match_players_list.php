                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tr>
                                ...
                                <td><?php 
                                $match =$this->db->get_where('match',array('match_id'=>base64_decode($this->uri->segment('3'))))->row();
                                 echo $match->type ?></td>
                                <td><?php echo $match_players->team_name ?></td>
                                <td><?php echo $match_players->name ?></td>
                                <td><?php echo $match_players->points ?></td>
                                <td><?php echo $match_players->selection_percent ?></td>
                                <td>
                                ...
                                <td><?php echo anchor(site_url('todaymatch/update/'.$match_players->id ),'<button style="border-radius: 6px;" type="button" class="btn btn-success" ><i class="fa fa-pencil" aria-hidden="true"></i></button>');  ?></td>
                            </tr>
                                <?php
                            }
                            ?>
