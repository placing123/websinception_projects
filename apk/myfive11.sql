...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2020 at 08:55 AM
...
(1, 'admin', 'admin address', 9999999999, 'admin@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 1, 0);
...
CREATE TABLE `contest` (
  ...
  `multiple_teams` tinyint(1) DEFAULT NULL COMMENT '1="Single team",2="multiple team"',
  `cancelled` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = Live , 1 = cancelled',
  `payment_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0="Not Done", 1 ="Payment done"	'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `contest_defalut` (`contest_id`, `contest_name`, `contest_tag`, `winners`, `prize_pool`, `total_team`, `join_team`, `entry`, `contest_description`, `contest_note1`, `contest_note2`, `winning_note`, `match_id`, `type`, `multiple_teams`) VALUES
(68, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 27, 2, 0, 15, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 14, '', 1),
(69, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 47, 3, 0, 17, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 5, '', 1),
(70, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 76, 3, 0, 27, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 29, '', 1),
(71, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 98, 3, 0, 35, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 18, '', 1),
(72, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 38, 2, 0, 21, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 18, '', 1),
(73, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 620, 3, 0, 230, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 29, '', 1),
(74, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 1070, 3, 0, 387, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 28, '', 2),
(75, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 2177, 3, 0, 777, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 18, '', 2),
(76, '4 MEMBER', 'LOW ENTRY BIG WINING', 1, 1930, 4, 0, 520, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 27, '', 2),
(77, 'PRACTIC CONTEST', 'LOW ENTRY BIG WINING', 1, 0, 10, 0, 0, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 28, '', 2),
(78, '4 MEMBER', 'LOW ENTRY. BIG WINNING', 1, 184, 4, 0, 49, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 1, '', 1),
(79, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 110, 2, 0, 59, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 17, '', 2),
(80, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 167, 2, 0, 88, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 18, '', 2),
(81, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 3800, 2, 0, 2055, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 16, '', 2),
(82, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 4465, 2, 0, 2455, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 19, '', 2),
(83, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 5200, 2, 0, 2875, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 18, '', 2),
(84, '4 MEMBER', 'LOW ENTRY BIG WINING', 1, 335, 4, 0, 89, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 19, '', 2),
(85, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 228, 2, 0, 120, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may  different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of ', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 20, '', 2),
(86, '3 MEMBER', 'LOW ENTRY BIG WINING', 1, 98, 3, 0, 35, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 19, '', 2),
(87, 'HEAD TO HEAD', 'LOW ENTRY BIG WINING', 1, 9000, 2, 0, 5055, 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax of 31.2% will be deducted.', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', 'The actual prize money may be different than the prize money mentioned above if there is a tie for any of the winning positions. Check FAQs for further details . As per government regulations, a tax o', '', 19, '', 2);

-- --------------------------------------------------------

--
-- Table structure for table `deposite_bonus`
--

CREATE TABLE `deposite_bonus` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `leaderboard` (
  ...
  `temprank` varchar(30) NOT NULL DEFAULT '0',
  `created_date` datetime NOT NULL,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `match` (
  ...
  `eleven_out` int(2) NOT NULL DEFAULT '0',
  ...
  `team1Score_secondInning` varchar(10) DEFAULT NULL,
  `team1Over_secondInning` varchar(10) DEFAULT NULL,
  `team2Score_secondInning` varchar(10) DEFAULT NULL,
  `team2Over_secondInning` varchar(10) DEFAULT NULL,
  `payment_status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0="Not Done", 1 ="Pyment done"',
  `match_status_note` varchar(255) DEFAULT NULL,
  `created_date` datetime NOT NULL,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `cancelled` tinyint(2) NOT NULL DEFAULT '0',
  `publish` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0="Not publish", 1 ="publish"',
  `complete_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0="Live", 1 ="Result"'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `match_players` (
  ...
  `playing_status` int(2) NOT NULL DEFAULT '0',
  `is_select` tinyint(4) NOT NULL,
  `points` int(11) NOT NULL DEFAULT '0',
  `selection_percent` int(11) NOT NULL DEFAULT '0',
  `total_points` varchar(10) NOT NULL DEFAULT '0',
  `batting_points` varchar(10) NOT NULL DEFAULT '0',
...
(3, 'Result', '2018-11-05 09:27:51', '2018-11-05 09:27:51');
...
(3, 'Test', '2018-11-05 09:31:18', '2018-11-05 09:31:18'),
(4, 'T10', '2018-11-05 09:31:18', '2018-11-05 09:31:18');
...
CREATE TABLE `my_match` (
  ...
  `winning_type` varchar(10) DEFAULT NULL,
  `cancelled` tinyint(1) NOT NULL DEFAULT '0',
  `contest_cancell` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = Live, 1 = cancelled',
  `complete_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0="Live", 1 ="Result"'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `my_team_player` (
  ...
  `batting_points` int(11) NOT NULL DEFAULT '0',
  `bolling_points` varchar(50) NOT NULL DEFAULT '0',
  `fielding_points` varchar(50) NOT NULL DEFAULT '0',
...
(4, NULL, 'IMG_20200911_112049.jpg', NULL, NULL, '', 0, '2020-09-11 11:21:16', '2020-09-11 05:51:16'),
(3, NULL, 'IMG_20200911_112328.jpg', NULL, NULL, '', 0, '2020-09-05 17:00:59', '2020-09-11 05:54:15'),
(6, NULL, 'PicsArt_09-21-03.49.31.jpg', NULL, NULL, '', 0, '2020-09-11 13:33:25', '2020-09-21 10:21:09'),
(7, NULL, 'IMG_20200920_162602.jpg', NULL, NULL, '', 0, '2020-09-20 16:26:26', '2020-09-20 10:56:26'),
(8, NULL, 'IMG_20200921_081742.jpg', NULL, NULL, '', 0, '2020-09-21 08:19:46', '2020-09-21 02:49:46');
...
CREATE TABLE `players` (
  ...
  `teamid` int(11) NOT NULL,
  `playing_status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '0= "Not playing", 1 ="Playing"	',
...
INSERT INTO `points_distribution_rules` (`id`, `title`, `t10score`, `t20score`, `odiscore`, `testscore`, `description`, `created_date`, `modified_date`) VALUES
(1, 'General', '4', '4', '4', '4', 'Being a part of the starting XI', '0000-00-00 00:00:00', '2020-07-25 18:09:58'),
(2, 'General', '1', '1', '1', '1', 'Every run scored', '0000-00-00 00:00:00', '2020-07-25 18:11:05'),
(3, 'General', '25', '25', '25', '16', 'Every wicket taken (excluding run out)', '0000-00-00 00:00:00', '2020-07-26 07:59:30'),
(7, 'General', '6', '6', '6', '6', 'Run Out(Catcher)', '2020-09-03 10:48:26', '2020-09-03 14:49:54'),
(8, 'General', '-2', '-2', '-3', '-4', 'Dismissal for a Duck (only for batsmen, wicket-keepers and all-rounders)', '0000-00-00 00:00:00', '2020-07-25 18:22:06'),
(9, 'Bonus Points', '1', '1', '1', '1', 'Every boundary hit', '0000-00-00 00:00:00', '2020-07-25 18:15:55'),
(10, 'Bonus Points', '2', '2', '2', '2', 'Every six hit', '0000-00-00 00:00:00', '2020-07-25 18:17:12'),
(11, 'Bonus Points', '8', '8', '4', '4', 'Half Century (50 runs scored by a batsman in a single innings)', '0000-00-00 00:00:00', '2020-08-03 15:37:19'),
(12, 'Bonus Points', '0', '16', '8', '8', 'Century (100 runs scored by a batsman in a single innings)', '0000-00-00 00:00:00', '2020-08-05 02:10:58'),
(13, 'Bonus Points', '16', '8', '4', '0', 'Maiden Over', '0000-00-00 00:00:00', '2020-07-25 18:42:32'),
(14, 'Bonus Points', '0', '8', '4', '4', '4 wickets', '0000-00-00 00:00:00', '2020-07-25 18:43:14'),
(15, 'Bonus Points', '0', '16', '8', '8', '5 wickets', '0000-00-00 00:00:00', '2020-07-25 18:43:50'),
(16, 'Economy Rate', '1 over', '2 overs', '5 overs', 'NA', 'Minimum overs bowled by player to be applicable', '2018-11-10 11:19:04', '2020-05-31 10:40:59'),
(17, 'Economy Rate', '0', '2', '0', '0', 'Between 6 and 5 runs per over', '0000-00-00 00:00:00', '2020-07-31 00:47:52'),
(18, 'Economy Rate', '0', '4', '0', '0', 'Between 4.99 and 4 runs per over', '0000-00-00 00:00:00', '2020-07-31 00:47:14'),
(19, 'Economy Rate', '0', '6', '0', '0', 'Below 4 runs per over', '0000-00-00 00:00:00', '2020-07-31 00:50:40'),
(20, 'Economy Rate', '0', '-2', '0', '0', 'Between 9 and 10 runs per over', '0000-00-00 00:00:00', '2020-08-02 11:15:31'),
(21, 'Economy Rate', '0', '-4', '0', '0', 'Between 10.01 and 11 runs per over', '0000-00-00 00:00:00', '2020-07-31 00:58:29'),
(22, 'Economy Rate', '0', '-6', '0', '0', 'Above 11 runs per over', '0000-00-00 00:00:00', '2020-07-31 00:53:41'),
(23, 'Economy Rate', '0', '0', '2', '0', 'Between 4.5 and 3.5 runs per over', '0000-00-00 00:00:00', '2020-07-31 00:52:21'),
(24, 'Economy Rate', '0', '0', '4', '0', 'Between 3.49 and 2.5 runs per over', '0000-00-00 00:00:00', '2020-07-26 03:17:22'),
(25, 'Economy Rate', '0', '0', '6', '0', 'Below 2.5 runs per over', '0000-00-00 00:00:00', '2020-07-26 03:17:54'),
(26, 'Economy Rate', '0', '0', '-2', '0', 'Between 7 and 8 runs per over', '0000-00-00 00:00:00', '2020-07-26 03:18:27'),
(27, 'Economy Rate', '0', '0', '-4', '0', 'Between 8.01 and 9 runs per over', '0000-00-00 00:00:00', '2020-07-26 03:19:00'),
(28, 'Economy Rate', '0', '0', '-6', '0', 'Above 9 runs per over', '0000-00-00 00:00:00', '2020-07-26 03:19:31'),
(29, 'Strike Rate', '5 balls', '10 balls', '20 balls', 'NA', 'Minimum balls faced by a player to be applicable', '2018-11-10 11:19:04', '2020-05-31 10:42:05'),
(30, 'Strike Rate', '0', '-2', '0', '0', 'Between 60 and 70 runs per 100 balls', '0000-00-00 00:00:00', '2020-08-02 10:11:14'),
(31, 'Strike Rate', '0', '-4', '0', '0', 'Between 50 and 59.99 runs per 100 balls', '0000-00-00 00:00:00', '2020-08-02 10:11:45'),
(32, 'Strike Rate', '0', '-6', '0', '0', 'Below 50 runs per 100 balls', '0000-00-00 00:00:00', '2020-08-02 10:12:25'),
(33, 'Strike Rate', '0', '0', '-2', '0', 'Between 50 and 60 runs per 100 balls', '0000-00-00 00:00:00', '2020-08-02 10:12:41'),
(34, 'Strike Rate', '0', '0', '-4', '0', 'Between 40 and 49.99 runs per 100 balls', '0000-00-00 00:00:00', '2020-08-02 10:13:02'),
(35, 'Strike Rate', '0', '0', '-6', '0', 'Below 40 runs per 100 balls', '0000-00-00 00:00:00', '2020-08-02 10:13:30'),
(36, 'Bonus Points', '8', 'NA', 'NA', 'NA', '2 wickets', '2020-05-31 16:13:50', '2020-05-31 10:45:15'),
(37, 'Bonus Points', '16', 'NA', 'NA', 'NA', '3 wickets', '2020-05-31 16:13:50', '2020-05-31 10:45:15'),
(38, 'Bonus Points', '8', 'NA', 'NA', 'NA', '30 runs scored by a batsman in a single innings', '2020-05-31 16:13:50', '2020-05-31 10:45:46'),
(39, 'Economy Rate', '6', 'NA', 'NA', 'NA', 'Below 6 runs per over', '2020-05-31 16:13:50', '2020-05-31 10:46:31'),
(40, 'Economy Rate', '4', 'NA', 'NA', 'NA', 'Between 6 and 6.99 runs per over', '2020-05-31 16:13:50', '2020-05-31 10:50:03'),
(41, 'Economy Rate', '2', 'NA', 'NA', 'NA', 'Between 7 and 8 runs per over', '2020-05-31 16:13:50', '2020-05-31 10:50:06'),
(42, 'Economy Rate', '-2', 'NA', 'NA', 'NA', 'Between 11 and 12 runs per over', '2020-05-31 16:13:50', '2020-05-31 10:50:09'),
(43, 'Economy Rate', '-4', 'NA', 'NA', 'NA', 'Between 12.01 and 13 runs per over', '2020-05-31 16:13:50', '2020-05-31 10:50:12'),
(44, 'Economy Rate', '-6', 'NA', 'NA', 'NA', 'Above 13 runs per over', '2020-05-31 16:17:55', '2020-05-31 10:49:06'),
(45, 'Strike Rate', '-2', 'NA', 'NA', 'NA', 'Between 90 and 100 runs per 100 balls', '2020-05-31 16:13:50', '2020-05-31 10:50:15'),
(46, 'Strike Rate', '-4', 'NA', 'NA', 'NA', 'Between 80 and 89.99 runs per 100 balls', '2020-05-31 16:17:55', '2020-05-31 10:49:35'),
(47, 'Strike Rate', '-6', 'NA', 'NA', 'NA', 'Below 80 runs per 100 balls', '2020-05-31 16:13:50', '2020-05-31 10:50:18'),
(5, 'General', '12', '12', '12', '12', 'Stumping/Run-out', '2020-09-03 10:39:59', '2020-09-03 14:42:40'),
(6, 'General', '6', '6', '6', '6', 'Run Out(Thrower)', '2020-09-03 10:46:08', '2020-09-03 14:47:54'),
(4, 'General', '8', '8', '8', '8', 'Catch', '2020-09-03 10:54:01', '2020-09-03 14:55:01');

-- --------------------------------------------------------

--
-- Table structure for table `popup_offer`
--

CREATE TABLE `popup_offer` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `popup_offer`
--

INSERT INTO `popup_offer` (`id`, `image`, `title`, `status`) VALUES
(7, 'IMG_20200921_083939.jpg', 'MAKE YOUR TEAM NOW', 1);
...
CREATE TABLE `registration` (
  ...
  `favriteTeam` varchar(100) NOT NULL DEFAULT ' ',
...
(1, 'Bonus', '50', '2020-09-13 08:00:53');
...
CREATE TABLE `team` (
  ...
  `team_image` varchar(255) NOT NULL DEFAULT 'team_default.png',
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `transection` (
  ...
  `contest_id` int(11) DEFAULT NULL,
  `withdrow_request` int(11) DEFAULT NULL COMMENT '"Pending" =1, "accept"=2, "Reject"=3',
...
INSERT INTO `version` (`id`, `note`, `old_version`, `new_version`, `maintenance_status`, `createdDate`, `modifiedDate`) VALUES
(1, 'Latest version', '1.0', '1.0', 0, '2019-06-03 06:35:15', '2020-09-13 07:58:23');
...
(2, 'Privacy Policy', '<p>At myfive11.com, accessible from https://myfive11.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by myfive11.com and how we use it.</p>\r\n\r\n<p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>\r\n\r\n<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in myfive11.com. This policy is not applicable to any information collected offline or via channels other than this website.</p>\r\n\r\n<h2>Consent</h2>\r\n\r\n<p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>\r\n\r\n<h2>Information we collect</h2>\r\n\r\n<p>The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point we ask you to provide your personal information.</p>\r\n\r\n<p>If you contact us directly, we may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.</p>\r\n\r\n<p>When you register for an Account, we may ask for your contact information, including items such as name, company name, address, email address, and telephone number.</p>\r\n\r\n<h2>How we use your information</h2>\r\n\r\n<p>We use the information we collect in various ways, including to:</p>\r\n\r\n<ul>\r\n <li>Provide, operate, and maintain our webste</li>\r\n <li>Improve, personalize, and expand our webste</li>\r\n <li>Understand and analyze how you use our webste</li>\r\n <li>Develop new products, services, features, and functionality</li>\r\n <li>Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the webste, and for marketing and promotional purposes</li>\r\n <li>Send you emails</li>\r\n <li>Find and prevent fraud</li>\r\n</ul>\r\n\r\n<h2>Log Files</h2>\r\n\r\n<p>myfive11.com follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services&#39; analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users&#39; movement on the website, and gathering demographic information.</p>\r\n\r\n<h2>Advertising Partners Privacy Policies</h2>\r\n\r\n<p>You may consult this list to find the Privacy Policy for each of the advertising partners of myfive11.com.</p>\r\n\r\n<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on myfive11.com, which are sent directly to users&#39; browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>\r\n\r\n<p>Note that myfield11.com has no access to or control over these cookies that are used by third-party advertisers.</p>\r\n\r\n<h2>Third Party Privacy Policies</h2>\r\n\r\n<p>myfive11.com&#39;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.</p>\r\n\r\n<p>You can choose to disable cookies through your individual browser options. To know more detailed information about cookie management with specific web browsers, it can be found at the browsers&#39; respective websites.</p>\r\n\r\n<h2>CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>\r\n\r\n<p>Under the CCPA, among other rights, California consumers have the right to:</p>\r\n\r\n<p>Request that a business that collects a consumer&#39;s personal data disclose the categories and specific pieces of personal data that a business has collected about consumers.</p>\r\n\r\n<p>Request that a business delete any personal data about the consumer that a business has collected.</p>\r\n\r\n<p>Request that a business that sells a consumer&#39;s personal data, not sell the consumer&#39;s personal data.</p>\r\n\r\n<p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>\r\n\r\n<h2>GDPR Data Protection Rights</h2>\r\n\r\n<p>We would like to make sure you are fully aware of all of your data protection rights. Every user is entitled to the following:</p>\r\n\r\n<p>The right to access – You have the right to request copies of your personal data. We may charge you a small fee for this service.</p>\r\n\r\n<p>The right to rectification – You have the right to request that we correct any information you believe is inaccurate. You also have the right to request that we complete the information you believe is incomplete.</p>\r\n\r\n<p>The right to erasure – You have the right to request that we erase your personal data, under certain conditions.</p>\r\n\r\n<p>The right to restrict processing – You have the right to request that we restrict the processing of your personal data, under certain conditions.</p>\r\n\r\n<p>The right to object to processing – You have the right to object to our processing of your personal data, under certain conditions.</p>\r\n\r\n<p>The right to data portability – You have the right to request that we transfer the data that we have collected to another organization, or directly to you, under certain conditions.</p>\r\n\r\n<p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>\r\n\r\n<h2>Children&#39;s Information</h2>\r\n\r\n<p>Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>\r\n\r\n<p>myfive11.com does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>'),
(3, 'About Us', '<p>Myfive11 is one of the most trustworthy cricket fantasy platform which allow people to make their dream true to build their own team. Our aim is to enhance the skill level of users to play fantasy cricket games in secured environment. As we all know that winning cash prizes is one of the main reason to play fantasy sports in India, but fantasy sports also doubles the excitement level of watching cricket matches. </p>\r\n\r\n<p>Our vision is open fortune doors for millions of cricket lovers who can showcase thier talent/skills and transform their passion into golden opportunities to earn great money prizes. Users can make their own team choosen from real-life cricket players from upcoming matches and they score points based on players on-field performance. Enjoy playing cricket fantasy games with us and win big prizes.</p>\r\n\r\n<p> </p>'),
(1, 'Terms and Conditions', '<p>Welcome to myfield11.com!</p>\r\n\r\n<p>If any error or technical issue occur and user get extra amount than he/she deposited or winning, user cannot claim on that amount.</p>\r\n\r\n<p>These terms and conditions outline the rules and regulations for the use of Myfield11&#39;s Website, located at https://myfield11.com.</p>\r\n\r\n<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use myfield11.com if you do not agree to take all of the terms and conditions stated on this page.</p>\r\n\r\n<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company’s terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services, in accordance with and subject to, prevailing law of Netherlands. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>\r\n\r\n<h3><strong>Cookies</strong></h3>\r\n\r\n<p>We employ the use of cookies. By accessing myfield11.com, you agreed to use cookies in agreement with the Myfield11&#39;s Privacy Policy.</p>\r\n\r\n<p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>\r\n\r\n<h3><strong>License</strong></h3>\r\n\r\n<p>Unless otherwise stated, Myfield11 and/or its licensors own the intellectual property rights for all material on myfield11.com. All intellectual property rights are reserved. You may access this from myfield11.com for your own personal use subjected to restrictions set in these terms and conditions.</p>\r\n\r\n<p>You must not:</p>\r\n\r\n<ul>\r\n <li>Republish material from myfield11.com</li>\r\n <li>Sell, rent or sub-license material from myfield11.com</li>\r\n <li>Reproduce, duplicate or copy material from myfield11.com</li>\r\n <li>Redistribute content from myfield11.com</li>\r\n</ul>\r\n\r\n<p>This Agreement shall begin on the date hereof. </p>\r\n\r\n<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Myfield11 does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Myfield11,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Myfield11 shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>\r\n\r\n<p>Myfield11 reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>\r\n\r\n<p>You warrant and represent that:</p>\r\n\r\n<ul>\r\n <li>You are entitled to post the Comments on our website and have all necessary licenses and consents to do so;</li>\r\n <li>The Comments do not invade any intellectual property right, including without limitation copyright, patent or trademark of any third party;</li>\r\n <li>The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material which is an invasion of privacy</li>\r\n <li>The Comments will not be used to solicit or promote business or custom or present commercial activities or unlawful activity.</li>\r\n</ul>\r\n\r\n<p>You hereby grant Myfield11 a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>\r\n\r\n<h3><strong>Hyperlinking to our Content</strong></h3>\r\n\r\n<p>The following organizations may link to our Website without prior written approval:</p>\r\n\r\n<ul>\r\n <li>Government agencies;</li>\r\n <li>Search engines;</li>\r\n <li>News organizations;</li>\r\n <li>Online directory distributors may link to our Website in the same manner as they hyperlink to the Websites of other listed businesses; and</li>\r\n <li>System wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and charity fundraising groups which may not hyperlink to our Web site.</li>\r\n</ul>\r\n\r\n<p>These organizations may link to our home page, to publications or to other Website information so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products and/or services; and (c) fits within the context of the linking party’s site.</p>\r\n\r\n<p>We may consider and approve other link requests from the following types of organizations:</p>\r\n\r\n<ul>\r\n <li>commonly-known consumer and/or business information sources;</li>\r\n <li>dot.com community sites;</li>\r\n <li>associations or other groups representing charities;</li>\r\n <li>online directory distributors;</li>\r\n <li>internet portals;</li>\r\n <li>accounting, law and consulting firms; and</li>\r\n <li>educational institutions and trade associations.</li>\r\n</ul>\r\n\r\n<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Myfield11; and (d) the link is in the context of general resource information.</p>\r\n\r\n<p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.</p>\r\n\r\n<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Myfield11. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>\r\n\r\n<p>Approved organizations may hyperlink to our Website as follows:</p>\r\n\r\n<ul>\r\n <li>By use of our corporate name; or</li>\r\n <li>By use of the uniform resource locator being linked to; or</li>\r\n <li>By use of any other description of our Website being linked to that makes sense within the context and format of content on the linking party’s site.</li>\r\n</ul>\r\n\r\n<p>No use of Myfield11&#39;s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>\r\n\r\n<h3><strong>iFrames</strong></h3>\r\n\r\n<p>Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.</p>\r\n\r\n<h3><strong>Content Liability</strong></h3>\r\n\r\n<p>We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.</p>\r\n\r\n<h3><strong>Your Privacy</strong></h3>\r\n\r\n<p>Please read Privacy Policy</p>\r\n\r\n<h3><strong>Reservation of Rights</strong></h3>\r\n\r\n<p>We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.</p>\r\n\r\n<h3><strong>Removal of links from our website</strong></h3>\r\n\r\n<p>If you find any link on our Website that is offensive for any reason, you are free to contact and inform us any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.</p>\r\n\r\n<p>We do not ensure that the information on this website is correct, we do not warrant its completeness or accuracy; nor do we promise to ensure that the website remains available or that the material on the website is kept up to date.</p>\r\n\r\n<h3><strong>Disclaimer</strong></h3>\r\n\r\n<p>To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our website and the use of this website. Nothing in this disclaimer will:</p>\r\n\r\n<ul>\r\n <li>limit or exclude our or your liability for death or personal injury;</li>\r\n <li>limit or exclude our or your liability for fraud or fraudulent misrepresentation;</li>\r\n <li>limit any of our or your liabilities in any way that is not permitted under applicable law; or</li>\r\n <li>exclude any of our or your liabilities that may not be excluded under applicable law.</li>\r\n</ul>\r\n\r\n<p>The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a) are subject to the preceding paragraph; and (b) govern all liabilities arising under the disclaimer, including liabilities arising in contract, in tort and for breach of statutory duty.</p>\r\n\r\n<p>As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.</p>\r\n\r\n<p> </p>'),
(4, 'Withdraw Cash', '<p><strong>Q.  How do I withdraw cash?  </strong></p>\r\n\r\n<p>* You can Withdrawal Cash at any time by going to My Profile page and clicking on Wallet Section, where you can find option to withdrawal cash.  </p>\r\n\r\n<p>* You are then asked to enter an amount you would like to withdraw.  </p>\r\n\r\n<p>* For making a withdrawal, you need to first verify your KYC. If you are not KYC verified, then you need to upload the latest copy of ID proofs. Our customer service team will review and verify your uploaded documents. After that you can easily request for withdrawal.  </p>\r\n\r\n<p>* You can only withdraw an amount less than or equal to your Withdrawable Balance. This will be shown to you on the Withdraw Cash page.    </p>\r\n\r\n<p><strong>Q.  What is the minimum amount I can withdraw?  </strong></p>\r\n\r\n<p>Minimum withdrawal amount in Myfield11 is Rs 150.    </p>\r\n\r\n<p><strong>Q.  What is the maximum amount I can withdraw?  </strong></p>\r\n\r\n<p>You can withdrawal all the money in your Myfive11 account. There is no upper cap in withdrawal.  </p>\r\n\r\n<p><strong>Q.  How can I view my Deposit and Withdrawal Account balance?</strong>  </p>\r\n\r\n<p>You can view all your deposited, winning and bonus balance in wallet section. You can find wallet section in your profile tab. To be mentioned, you can only be able to withdraw your winning balance.  </p>\r\n\r\n<p><strong>Q.  How do I transfer the prize money into my bank account? </strong> </p>\r\n\r\n<p>To transfer your winning money into your bank account, you need to go Myfive11 > My Profile > Wallet > Withdraw Cash. Before withdrawal, you need to verify your KYC documents.  </p>\r\n\r\n<p><strong>Q.  How long will it take for money transfer?  </strong></p>\r\n\r\n<p>Normally it takes 2-5 working days for the money to get credited in your bank account. It may vary in some special cases and from different bank to bank.  </p>\r\n\r\n<p><strong>Q.  Can I change my team name? </strong> </p>\r\n\r\n<p>The name of your team is your unique identity on Myfive11 and hence cannot be changed. Your team name help us to assess your performances.  </p>\r\n\r\n<p><strong>Q. Can I play if I am under the age of 18?</strong></p>\r\n\r\n<p>No, you must have to be 18+ to play fantasy cricket games in Myfive11.    </p>\r\n\r\n<p><strong>Q.  Why was my money refunded?  </strong></p>\r\n\r\n<p>You get refund when a contest you were joined in get cancelled. This may happens because the contest does not gather the required number of contestants or that match may called off.</p>\r\n\r\n<p><strong>Q. What is the maximum amount limit of withdrawal?</strong></p>\r\n\r\n<p>You can make withdrawal request of any amount between Rs 150 - Rs 9999. Maximum limit for withdrawal is Rs 9999.</p>\r\n\r\n<p><strong>Q. How many teams I can create?</strong></p>\r\n\r\n<p>You can create maximum of 11 teams for any league.</p>\r\n\r\n<p><strong>Q. I have added money in my wallet but money didn&#39;t added in my wallet after successful payment? </strong></p>\r\n\r\n<p>Sorry for your inconvenience, this kind of issues are very rare but if you ever face this problem or any other issue related to payment, kindly mail us with your problem at &#39;&#39;  &#39;&#39; .</p>'),
(5, 'Legality', '<p>• Playing games of skill is legal as it is excluded from the ambit of Indian gambling legislations, including the Public Gambling Act of 1867.The Supreme Court of India, in the cases of State of Andhra Pradesh v. K Satyanarayana (AIR 1968 SC 825) and KR Lakshmanan v. State of Tamil Nadu (AIR 1996 SC 1153), has held that a game in which success depends predominantly upon the superior knowledge, training, attention, experience and adroitness of the player shall be classified as a game of skill.  </p>\r\n\r\n<p>•  The law in Assam, Orissa, Telangana, Sikkim or Nagaland is unclear on playing fantasy games of skill for cash prizes, therefore users from these five states are prohibited from playing cash contests on Myfive11.</p>\r\n\r\n<p>• The Contents provided by Myfive11, described above, are games of skill as Participants’ success in the games depends primarily on their superior knowledge of the games of cricket statistics, knowledge of players&#39; relative form, players&#39; performance in a particular territory, conditions and/or format (such as ODIs, Test Cricket and Twenty20 in the cricket fantasy game), attention and dedication to the Contests in which they are participating and expertise in playing the Contests. The Contests also require Participants to field well-balanced sides with limited resources and make substitutions at appropriate times to gain the maximum points.    </p>\r\n\r\n<p>• By participating in our Contests, each Participant acknowledges and agrees that he/she is participating in a game of skill, not chance.</p>'),
(6, 'Refund Policy', '<p>• Any amount once added to Myfive11 account of user can&#39;t be refunded back to the user in any case, and the amount can only be used to join the leagues and contests organised by Myfive11.  </p>\r\n\r\n<p>• In case of any unexpected event like force majeure, event cancellation, or technical errors and others, only league joining amount will be refunded as used to join the league, there will be no claim on the winning as per the rank.•</p>\r\n\r\n<p>• If there will be any delay or unexpected event happen because of which match got cancelled, all the contests for that match in Myfive11 will be cancelled and league joining amount will be refunded.  </p>\r\n\r\n<p>• Myfieve11 reserves the right to cancel any matches for any reason, with or without disclosure of the reason, and refund all fees paid for such matches by any and all Users.</p>');
...
--
-- Indexes for table `deposite_bonus`
--
ALTER TABLE `deposite_bonus`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `popup_offer`
--
ALTER TABLE `popup_offer`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `contest_defalut`
  MODIFY `contest_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `deposite_bonus`
--
ALTER TABLE `deposite_bonus`
...
--
ALTER TABLE `my_match`
  MODIFY `my_match_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `popup_offer`
--
ALTER TABLE `popup_offer`
...
--
ALTER TABLE `user_contest`
  MODIFY `user_Contestid` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `winning_information`
  MODIFY `winning_info_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `winning_information_default`
--
ALTER TABLE `winning_information_default`
  MODIFY `winning_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
