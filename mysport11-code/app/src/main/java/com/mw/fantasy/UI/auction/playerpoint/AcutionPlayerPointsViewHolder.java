...
public class AcutionPlayerPointsViewHolder extends RecyclerView.ViewHolder {

    SimpleDraweeView mSimpleDraweeView;
    CustomTextView mCustomTextViewName;
    CustomTextView mCustomTextViewPoints;
    CustomTextView mCustomTextViewSelectedBy,teamName;
    CardView mRelativeLayout;
    ImageView mImageView;
    ImageView mImageViewTopPlayer;

    public AcutionPlayerPointsViewHolder(View itemView) {
        super(itemView);
        ...
        teamName = (CustomTextView) itemView.findViewById(R.id.teamName);
    }
}
