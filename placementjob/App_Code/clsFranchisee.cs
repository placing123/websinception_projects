...
public class clsFranchisee
{
    ...
    public string spaceerror { get; set; }
    ...
    public int Update_Tbl_Client_Bpo_Data()
    {
        ...
        {
            objconn.Open();
            return SqlHelper.ExecuteNonQuery(objconn, "Update_Tbl_Client_Bpo_Data", Id, CId, Tbc_No, Name, EmailId, MobileNo, Gender, LicenseNo, GirNo, PanNo, H_Address, H_City, H_PinNo, H_State, O_Address, O_City, O_PinNo, LAL, MRNNo, AF, NRI, CP, Status,Reg_Date,spaceerror);
        }
    }
