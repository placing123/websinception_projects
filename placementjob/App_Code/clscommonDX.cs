...
public class clscommonDX
{
    ...
    public static void CheckConnection()
    {
        try
        {
            using (SqlConnection cn = new SqlConnection(clscommonDX.GetConnectionString))
            {
                cn.Open();
            }
        }
    ...
    public static string GetConnectionString
    {
        get
        {
            if (System.Web.HttpContext.Current.Session["alternate"] == null)
                return System.Configuration.ConfigurationManager.ConnectionStrings["connstrDX"].ToString();               
            else
                return System.Configuration.ConfigurationManager.ConnectionStrings["connstrDX"].ToString();
        }
    }
