<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Offline_Client.aspx.cs" Inherits="Customer_Offline_Client" %>
  ...
  <div class="mid_bg">
    ...
    <div id="first" runat="server">
        <div class="mid_min">
            ...
            Download Data:&nbsp;&nbsp;&nbsp;             <asp:Button ID="btn_download" runat="server" onclick="btn_download_Click" 
                Text="Download" Width="101px" />
                    </div>
      </div>
      </div>
