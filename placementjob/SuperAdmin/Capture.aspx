<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Capture.aspx.cs" Inherits="Control_Capture" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Customer Captured Image</title>
</head>
<body>
    ...
    <table cellpadding="10" cellspacing="10" style="border: solid 10px red; background-color: Skyblue;"  
        ...
        <tr>  
            <td style="height: 35px; background-color: Yellow; font-weight: bold; font-size: 16pt;  
                ...
                View And Download Customer Captured Image   
            </td>  
        </tr>  
        <tr>  
            <td>  
