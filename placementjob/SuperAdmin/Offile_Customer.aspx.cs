...
public partial class Admin_Offile_Customer : System.Web.UI.Page
{
    ...
    {
        Session["Cus_Username"] = txt_cid.Text.Trim();
        ...
        //    for (int i = 0; i < dt.Rows.Count; i++)
        //    {
        //        first[0] = dt.Rows[i]["Name"].ToString();
        //        first[1] = dt.Rows[i]["MobileNo"].ToString();
        //        first[2] = dt.Rows[i]["LicenseNo"].ToString();
        //        first[3] = dt.Rows[i]["PanNo"].ToString();
        //        first[4] = dt.Rows[i]["H_City"].ToString();

        //        second[0] = dt.Rows[i + 1]["Name"].ToString();
        //        second[1] = dt.Rows[i + 1]["MobileNo"].ToString();
        //        second[2] = dt.Rows[i + 1]["LicenseNo"].ToString();
        //        second[3] = dt.Rows[i + 1]["PanNo"].ToString();
        //        second[4] = dt.Rows[i + 1]["H_City"].ToString();

        //        dt.Rows[i]["Name"] = second[0];
        //        dt.Rows[i]["MobileNo"] = second[1];
        //        dt.Rows[i]["LicenseNo"] = second[2];
        //        dt.Rows[i]["PanNo"] = second[3];
        //        dt.Rows[i]["H_City"] = second[4];

        //        dt.Rows[i + 1]["Name"] = first[0];
        //        dt.Rows[i + 1]["MobileNo"] = first[1];
        //        dt.Rows[i + 1]["LicenseNo"] = first[2];
        //        dt.Rows[i + 1]["PanNo"] = first[3];
        //        dt.Rows[i + 1]["H_City"] = first[4];
        ...
        //    {
        //        first[0] = dt.Rows[i]["Tbc_No"].ToString();
        //        first[1] = dt.Rows[i]["EmailId"].ToString();
        //        first[2] = dt.Rows[i]["Gender"].ToString();
        //        first[3] = dt.Rows[i]["GirNo"].ToString();
        //        first[4] = dt.Rows[i]["H_Address"].ToString();

        //        second[0] = dt.Rows[i + 1]["Tbc_No"].ToString();
        //        second[1] = dt.Rows[i + 1]["EmailId"].ToString();
        //        second[2] = dt.Rows[i + 1]["Gender"].ToString();
        //        second[3] = dt.Rows[i + 1]["GirNo"].ToString();
        //        second[4] = dt.Rows[i + 1]["H_Address"].ToString();


        //        dt.Rows[i]["Tbc_No"] = second[0];
        //        dt.Rows[i]["EmailId"] = second[1];
        //        dt.Rows[i]["Gender"] = second[2];
        //        dt.Rows[i]["GirNo"] = second[3];
        //        dt.Rows[i]["H_Address"] = second[4];

        //        dt.Rows[i + 1]["Tbc_No"] = first[0];
        //        dt.Rows[i + 1]["EmailId"] = first[1];
        //        dt.Rows[i + 1]["Gender"] = first[2];
        //        dt.Rows[i + 1]["GirNo"] = first[3];
        //        dt.Rows[i + 1]["H_Address"] = first[4];
