<%@ Page Language="C#" MasterPageFile="~/SuperAdmin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="signedagreement.aspx.cs" Inherits="Admin_ClientRegistration" Title="Signed Agreement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="left" valign="top" class="pro_tit">Signed Agreement
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:GridView ID="grd_client_active" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_active" runat="server" OnClick="btn_active_Click" PostBackUrl='<%# Eval("Cid" ,"signedagreement.aspx?Cid={0}") %>'>Active</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="PlanId" SortExpression="PlanId">
                             ...
                             <asp:TemplateField HeaderText="Resend">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_resendagreement" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="resendagreement">Resend</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Signature">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_downloadsignature" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="downloadsignature">Download</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                ...
                <td>
                    <asp:GridView ID="grd_client_deactive" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_send" runat="server" OnClick="btn_send_Click" PostBackUrl='<%# Eval("cid","signedagreement.aspx?cid={0}") %>'>Send</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="btn_edit" runat="server" OnClick="btn_edit_Click" PostBackUrl='<%# Eval("cid","signedagreement.aspx?cid={0}") %>'>Edit</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
