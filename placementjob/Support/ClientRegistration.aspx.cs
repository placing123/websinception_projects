...
public partial class Admin_ClientRegistration : System.Web.UI.Page
{
    ...
    protected void grd_client_deactive_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "sendacknowledge")
        {
            ...
            msg = msg + "HI<br/>";
            msg = msg + "We have already provided you login id and password in the previous mail along with the link of the website which is    http://anbprojection.com  from where you can login and start your work.<br/><br/>";
            msg = msg + "<b>  Customer Support(10:30 AM to 6:30 PM):+91 7041272906 , +91 7041372908</b><br/><br/>";
